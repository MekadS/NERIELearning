...
public class ConstantUtils {
    ...
    public static final String REGEXP_ALPHABET_NUMBER_ONLY_NOT_NULL = "^[a-zA-Z 0-9]+$";
    public static final String REGEXP_ALPHABET_NUMBER_DASH_ONLY_NOT_NULL = "^[a-zA-Z0-9- ]+$";
